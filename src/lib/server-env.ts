...
/**
 * True when the bearer token belongs to an admin or editor. Import routes call
 * this after `verifySupabaseUser` so a signed-in student cannot burn Gemini /
 * OpenRouter quota through `/api/import/*`.
 */
