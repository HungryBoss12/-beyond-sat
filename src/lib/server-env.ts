...
/**
 * Returns whether the bearer token belongs to an admin or editor.
 *
 * Import routes call Gemini/OpenRouter on every request, so a signed-in
 * student would otherwise burn quota through `/api/import/*`.
 */
